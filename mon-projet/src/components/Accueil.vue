...
<div class="border-t-2 border-[#FFFFFF] w-16 mx-auto mt-2"></div>
...
<br>   
    ...
    <!-- Trombinoscope app.vue-->
        ...
        <div class="trombinoscope-app-container">
            ...
            <p class="profile-name">Cédric Chauvet</p>
            <p class="profile-title">Développeur IA et Automatisation </p>
          </div>
            
            <div class="profile">
            
              <p class="profile-name">Xavier Piedallu</p>
              <p class="profile-title">Architecte Web Full-Stack</p>
            </div>
      ...
      <div class="bandeau_bleu mt-6">
        <div class="bandeau_bleu-text-container">
          ...
          <br>
          <div>
            <h2 class="page-blanche_app-title font-semibold mt-4 text-white" style="font-size: 20px;">

              Mentions légales
            </h2>
            <br>
            <h3 class="mt-2 text-xs max-w-s text-white" style="font-size: 12px;">
              BTC Énergies (SAS) au capital de 120€, enregistrée au RCS de Toulouse, numéro SIRET : 928 497 585 00010
            </h3>
            <br>
...
export default {
  ...
  setup() {
    onMounted(() => {
      /** Effet Fade + Slide pour le bandeau bleu **/
      const bandeauBleuText = document.querySelector(".bandeau_bleu-text");
      if (bandeauBleuText) {
        gsap.fromTo(
          bandeauBleuText,
          { opacity: 0, y: -40 },
          { opacity: 1, y: 0, duration: 3.1, ease: "power2.out" }
        );
      }

      /** Effet Fade-in pour les sections de contenu **/
      gsap.fromTo(
      ...
      /** Animation des blocs "Nos Services" au survol **/
